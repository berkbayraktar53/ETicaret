using ETicaret.MvcWebUI.DB;
using ETicaret.MvcWebUI.Filter;
using ETicaret.MvcWebUI.Models.Account;
using System;
...
namespace ETicaret.MvcWebUI.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            List<ETicaret.MvcWebUI.DB.Addresses> addresses = null;
            ETicaret.MvcWebUI.DB.Addresses currentAddress = new ETicaret.MvcWebUI.DB.Addresses();
            if (id == 0)
            {
        ...
        [HttpPost]
        [MyAuthorization]
        public ActionResult Address(ETicaret.MvcWebUI.DB.Addresses address)
        {
            ETicaret.MvcWebUI.DB.Addresses _address = null;
