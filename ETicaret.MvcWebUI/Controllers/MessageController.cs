...
using ETicaret.MvcWebUI.Models.Message;
using System;
...
namespace ETicaret.MvcWebUI.Controllers
{
    ...
    public class MessageController : BaseController
    {
        ...
        public ActionResult SendMessage(Models.Message.SendMessageModel message)
        {
            ...
            ETicaret.MvcWebUI.DB.Messages mesaj = new ETicaret.MvcWebUI.DB.Messages()
            {
                Id = Guid.NewGuid(),
            ...
            var mRep = new ETicaret.MvcWebUI.DB.MessageReplies()
            {
                Id = Guid.NewGuid(),
                AddedDate = DateTime.Now,
        ...
        public ActionResult MessageReplies(string id)
        {
            ...
            ETicaret.MvcWebUI.DB.Messages message = context.Messages.FirstOrDefault(x => x.Id == guid);
        ...
        [HttpPost]
        public ActionResult MessageReplies(ETicaret.MvcWebUI.DB.MessageReplies message)
        {
            if (IsLogon() == false) return RedirectToAction("index", "i");
